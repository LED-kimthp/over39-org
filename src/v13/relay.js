...
import { greetingTranslationNeeded, translateArrivedGreeting } from "./depth.js?v=v7-20260924-r83";
import { GREETING_LONG_CHARS, greetingParagraphsOf, languageLabel, narrowLanguage } from "./greeting-text.js?v=v7-20260924-r83";
...
const composeCopy = {
  ...
  en: { begin: "After reading, leave one sentence for the next person", visibility: "Choose how you will appear to the recipient.", named: "Show my name or chosen label", contextual: "Show only my role or region", anonymous: "Leave it anonymously", translation: "If it reaches another language, should a translation appear with it?", translationYes: "Show the original and a translation", translationNo: "Show the original only", translationNote: "When this reaches someone who reads another language, a translation travels alongside your original.", preview: "Review what the recipient sees", previewTitle: "What the recipient sees", confirm: "I understand that contact details and the full survey are not shared, and I entrust this sentence to the next person.", back: "Edit the sentence" },
  ja: { begin: "この便りを読み、次の人へ一文を残す", visibility: "相手に見える表記を選んでください。", named: "名前または選んだ表記を見せる", contextual: "役割・地域だけを見せる", anonymous: "匿名で残す", translation: "別の言語の人に届く時、翻訳も一緒に見せますか？", translationYes: "原文と翻訳を一緒に見せる", translationNo: "原文だけを見せる", translationNote: "別の言語を読む方に届くときは、原文とともに翻訳が届きます。", preview: "相手に見える内容を確認する", previewTitle: "相手に見える内容", confirm: "連絡先と調査全体が渡らないことを確認し、この一文を次の人へ託します。", back: "文章を見直す" },
  "zh-Hans": { begin: "读完后，为下一位参与者留下一句话", visibility: "请选择对方看到的署名方式。", named: "显示姓名或选择的称呼", contextual: "只显示角色或地区", anonymous: "匿名留下", translation: "传到其他语言使用者时，要同时显示翻译吗？", translationYes: "同时显示原文和翻译", translationNo: "只显示原文", translationNote: "送到使用其他语言的人手中时，译文会与原文一起送达。", preview: "确认对方看到的内容", previewTitle: "对方看到的内容", confirm: "我已确认联系方式和完整问卷不会传递，并将这句话托付给下一位参与者。", back: "重新查看句子" },
  "zh-Hant": { begin: "讀完後，為下一位參與者留下一句話", visibility: "請選擇對方看到的署名方式。", named: "顯示姓名或選擇的稱呼", contextual: "只顯示角色或地區", anonymous: "匿名留下", translation: "傳到其他語言使用者時，要同時顯示翻譯嗎？", translationYes: "同時顯示原文和翻譯", translationNo: "只顯示原文", translationNote: "送到使用其他語言的人手中時，譯文會與原文一起送達。", preview: "確認對方看到的內容", previewTitle: "對方看到的內容", confirm: "我已確認聯絡方式和完整問卷不會傳遞，並將這句話託付給下一位參與者。", back: "重新查看句子" },
  ...
  es: { begin: "Después de leerlo, deje una frase para la siguiente persona", visibility: "Elija cómo aparecerá ante quien lo reciba.", named: "Mostrar mi nombre o la mención elegida", contextual: "Mostrar solo mi rol o región", anonymous: "Dejarlo de forma anónima", translation: "Si llega a otra lengua, ¿se muestra también una traducción?", translationYes: "Mostrar original y traducción", translationNo: "Mostrar solo el original", translationNote: "Si llega a alguien que lee otro idioma, la traducción viaja junto a su texto original.", preview: "Revisar lo que verá la persona", previewTitle: "Lo que verá la persona", confirm: "Entiendo que no se comparten los datos de contacto ni la encuesta completa, y confío esta frase a la siguiente persona.", back: "Revisar la frase" },
  nl: { begin: "Laat na het lezen één zin achter voor de volgende persoon", visibility: "Kies hoe u voor de ontvanger zichtbaar bent.", named: "Toon mijn naam of gekozen aanduiding", contextual: "Toon alleen mijn rol of regio", anonymous: "Laat het anoniem achter", translation: "Als het een andere taal bereikt, ook een vertaling tonen?", translationYes: "Toon origineel en vertaling", translationNo: "Toon alleen het origineel", translationNote: "Bereikt dit iemand die een andere taal leest, dan reist er een vertaling mee met uw oorspronkelijke tekst.", preview: "Bekijk wat de ontvanger ziet", previewTitle: "Wat de ontvanger ziet", confirm: "Ik begrijp dat contactgegevens en de volledige enquête niet worden gedeeld en vertrouw deze zin toe aan de volgende persoon.", back: "De zin herzien" },
  ms: { begin: "Selepas membacanya, tinggalkan satu ayat untuk orang seterusnya", visibility: "Pilih bagaimana anda dipaparkan kepada penerima.", named: "Paparkan nama atau label pilihan saya", contextual: "Paparkan peranan atau rantau sahaja", anonymous: "Tinggalkan secara tanpa nama", translation: "Jika sampai kepada bahasa lain, paparkan terjemahan juga?", translationYes: "Paparkan teks asal dan terjemahan", translationNo: "Paparkan teks asal sahaja", translationNote: "Apabila ia sampai kepada seseorang yang membaca bahasa lain, terjemahan dihantar bersama teks asal anda.", preview: "Semak apa yang dilihat penerima", previewTitle: "Apa yang dilihat penerima", confirm: "Saya faham bahawa maklumat hubungan dan keseluruhan soal selidik tidak dikongsi, dan saya mengamanahkan ayat ini kepada orang seterusnya.", back: "Semak semula ayat" },
};
