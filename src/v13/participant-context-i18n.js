...
const contextualCopy = {
  ko: {
    AUDIENCE: { activityHeading: "요즘 문화예술을 만나는 방식을 살펴볼게요.", p14: "요즘 문화예술을 만나는 방식은 어느 쪽에 가까운가요?", p15: "실제 관람·참여 방식은 어떤 흐름에 가까운가요?", p12: "문화예술을 만나는 방식이 달라졌다고 느낀 한 장면을 들려주세요.", p13: "공연·전시·프로그램을 자주 찾지 않던 때가 있었다면, 그때도 이어지던 관심이 있었나요? 다른 길로 이어졌어도 괜찮아요.", p16: "요즘 문화예술을 만나는 방식에 영향을 주고 있는 현실은 무엇인가요?", p19: "문화예술을 찾고 기억하게 한 기반이나 계기는 무엇이었나요?" },
    EVERYDAY: { activityHeading: "생활 안에서 이어지는 활동의 모습을 살펴볼게요.", p14: "요즘 이 활동은 어떤 모습으로 이어지고 있나요?", p15: "연습·모임·공연·발표처럼 이 활동이 다른 사람과 만나는 방식은 어떤 상태에 가까운가요?", p12: "그 변화가 연습·모임·공연·생활의 리듬에서 어떻게 느껴졌는지 한 장면 들려주세요.", p13: "밖으로 크게 드러나지 않던 때가 있었다면, 그때도 계속하던 것이 있었나요? 아주 작은 것이어도 괜찮아요.", p16: "이 활동의 리듬에 영향을 주고 있는 생활과 현실의 조건은 무엇인가요?", p19: "이 활동을 이어오게 한 사람·공간·배움·생활의 기반은 무엇이었나요?" },
    PROFESSIONAL: { activityHeading: "현재의 활동과 외부와 만나는 방식을 나누어 살펴볼게요.", p14: "현재 가장 중요한 문화예술 활동은 어떤 상태에 가까운가요?", p15: "현재 그 활동이 외부와 만나는 방식은 어떤 상태에 가까운가요?", p12: "그 전후로 달라진 것을 한 가지 들려주세요.", p13: "활동이 밖에서 잘 보이지 않던 때가 있었다면, 그때도 계속하던 일이 있었나요? 남들은 몰랐던 일이어도 괜찮아요.", p16: "현재의 활동 방식에 영향을 주고 있는 현실은 무엇인가요?", p19: "지금까지 활동을 이어오게 한 기반이나 계기는 무엇이었나요?" },
  },
  en: {
