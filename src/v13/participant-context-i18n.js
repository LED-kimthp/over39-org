...
const base = {
  ...
  fr: {
    more: "Préciser si vous le souhaitez — comment, sous quelle forme, l’expérience de qui",
  ...
  es: {
    more: "Añadir más detalle — cómo, en qué forma, la experiencia de quién",
  ...
  nl: {
    more: "Meer detail toevoegen — hoe, in welke vorm, wiens ervaring",
...
const contextualCopy = {
  ...
  en: {
    AUDIENCE: { activityHeading: "How do you meet arts and culture these days?", p14: "Which description is closest to how you meet arts and culture these days?", p15: "Which flow is closest to your actual visits and participation?", p12: "Please share one moment when the way you meet arts and culture felt different.", p13: "If there was a time when you rarely went to performances, exhibitions, or programmes, did an interest still continue then? It counts even by another route.", p16: "What realities are shaping how you meet arts and culture these days?", p19: "What has helped you seek out and remember arts and culture?" },
    EVERYDAY: { activityHeading: "How is this activity carrying on in your everyday life these days?", p14: "Which description is closest to how this activity is continuing these days?", p15: "Which description is closest to how this activity meets other people through practice, gatherings, performance, or sharing?", p12: "Please share one moment showing how that change felt in practice, gatherings, performance, or everyday rhythm.", p13: "If there was a time when it was not very visible to others, was there anything you kept doing then? Even something very small counts.", p16: "What everyday and practical conditions are shaping this activity’s rhythm?", p19: "What people, spaces, learning, or everyday foundations have helped this activity continue?" },
    PROFESSIONAL: { activityHeading: "What does your activity look like now, and how does it meet the world outside?", p14: "Which description is closest to the state of your most important arts and culture activity?", p15: "Which of these comes closest to how that activity meets the world outside at the moment?", p12: "Please share one thing that changed around that time.", p13: "If there was a time when your work was not very visible from outside, was there anything you kept doing then? It counts even if nobody knew.", p16: "What realities are shaping your current way of working?", p19: "What foundation or turning point has helped you continue this activity so far?" },
  },
  ja: {}, "zh-Hans": {}, "zh-Hant": {}, fr: {}, es: {}, nl: {}, ms: {},
};

const contextualLanguage = {
  ja: { AUDIENCE: ["最近、文化芸術とはどのように出会っていますか。","最近の文化芸術との出会い方に最も近いものはどれですか？","実際の鑑賞・参加の流れに最も近いものはどれですか？","文化芸術との出会い方が変わったと感じた場面を一つ教えてください。","公演・展覧会・プログラムにあまり足を運ばなかった時期があったなら、その間も続いていた関心はありましたか？別の道でつながっていてもかまいません。","最近の文化芸術との出会い方に影響している現実的な条件は何ですか？","文化芸術を再び訪ね、記憶する支えやきっかけは何でしたか？"], EVERYDAY: ["暮らしの中で、この活動は最近どのように続いていますか。","最近、この活動はどのような形で続いていますか？","稽古・集まり・公演・発表を通して、この活動が他者と出会う方法に最も近いものはどれですか？","その変化が稽古や集まり、公演、生活のリズムでどう感じられたか、一つの場面を教えてください。","外に大きく現れなかった時期があったなら、その間も続けていたことはありましたか？ごく小さなことでもかまいません。","この活動のリズムに影響している生活上・現実上の条件は何ですか？","この活動を続ける助けとなった人、場所、学び、生活の基盤は何ですか？"], PROFESSIONAL: ["今の活動はどのような姿で、外とはどのように出会っていますか。","今、いちばん大切にしている文化芸術の活動は、どの状態に近いですか？","その活動が外とつながる形は、今どの状態に近いですか？","その前後で変わったことを一つ教えてください。","活動が外からあまり見えなかった時期があったなら、その間も続けていたことはありましたか？誰も知らなかったことでもかまいません。","現在の活動方法に影響している現実は何ですか？","これまで活動を続けてこられた基盤やきっかけは何でしたか？"] },
  "zh-Hans": { AUDIENCE: ["您最近是如何接触文化艺术的呢？","哪种描述最接近您最近接触文化艺术的方式？","哪种描述最接近您实际参观和参与的节奏？","请分享一个让您觉得接触文化艺术的方式发生变化的时刻。","如果曾有一段时间，您不常去看演出、展览或参加活动，那段时间仍有持续的兴趣吗？通过其他途径延续也没关系。","哪些现实条件正在影响您最近接触文化艺术的方式？","什么基础或契机帮助您重新接触并记住文化艺术？"], EVERYDAY: ["在生活中，这项活动最近是如何延续的呢？","哪种描述最接近这项活动最近延续的样子？","哪种描述最接近这项活动通过练习、聚会、演出或分享与他人相遇的方式？","请分享一个场景，说明这种变化如何出现在练习、聚会、演出或生活节奏中。","如果曾有一段时间，这件事不太为外人所见，那段时间您仍有持续在做的事吗？再小的事也没关系。","哪些生活和现实条件正在影响这项活动的节奏？","哪些人、空间、学习或生活基础帮助这项活动延续？"], PROFESSIONAL: ["您现在的活动是什么样子，又是如何与外界相遇的呢？","您目前最重要的那项文化艺术活动，现在比较接近什么状态？","这项活动现在与外界相遇的方式，比较接近什么状态？","请分享一件在那前后发生变化的事。","如果曾有一段时间，您的活动在外界不太看得见，那段时间您仍有持续在做的事吗？别人不知道也没关系。","哪些现实正在影响您目前的活动方式？","是什么基础或契机让您至今能够继续这项活动？"] },
  "zh-Hant": { AUDIENCE: ["您最近是如何接觸文化藝術的呢？","哪種描述最接近您最近接觸文化藝術的方式？","哪種描述最接近您實際參觀和參與的節奏？","請分享一個讓您覺得接觸文化藝術的方式發生變化的時刻。","如果曾有一段時間，您不常去看演出、展覽或參加活動，那段時間仍有持續的興趣嗎？透過其他途徑延續也沒關係。","哪些現實條件正在影響您最近接觸文化藝術的方式？","什麼基礎或契機幫助您重新接觸並記住文化藝術？"], EVERYDAY: ["在生活中，這項活動最近是如何延續的呢？","哪種描述最接近這項活動最近延續的樣子？","哪種描述最接近這項活動透過練習、聚會、演出或分享與他人相遇的方式？","請分享一個場景，說明這種變化如何出現在練習、聚會、演出或生活節奏中。","如果曾有一段時間，這件事不太為外人所見，那段時間您仍有持續在做的事嗎？再小的事也沒關係。","哪些生活和現實條件正在影響這項活動的節奏？","哪些人、空間、學習或生活基礎幫助這項活動延續？"], PROFESSIONAL: ["您現在的活動是什麼樣子，又是如何與外界相遇的呢？","您目前最重要的那項文化藝術活動，現在比較接近什麼狀態？","這項活動現在與外界相遇的方式，比較接近什麼狀態？","請分享一件在那前後發生變化的事。","如果曾有一段時間，您的活動在外界不太看得見，那段時間您仍有持續在做的事嗎？別人不知道也沒關係。","哪些現實正在影響您目前的活動方式？","是什麼基礎或契機讓您至今能夠繼續這項活動？"] },
  fr: { AUDIENCE: ["Comment rencontrez-vous l’art et la culture ces temps-ci ?","Quelle description se rapproche le plus de votre manière actuelle de rencontrer les arts et la culture ?","Quelle description se rapproche le plus de vos visites et participations effectives ?","Racontez un moment où votre manière de rencontrer les arts et la culture a changé.","S’il y a eu une période où vous alliez rarement voir des spectacles, des expositions ou des programmes, un intérêt continuait-il malgré tout ? Même par un autre chemin, cela compte.","Quelles réalités influencent aujourd’hui votre manière de rencontrer les arts et la culture ?","Qu’est-ce qui vous a aidé à revenir vers les arts et la culture et à les garder en mémoire ?"], EVERYDAY: ["Comment cette activité se poursuit-elle dans votre vie quotidienne ces temps-ci ?","Quelle description se rapproche le plus de la façon dont cette activité se poursuit aujourd’hui ?","Quelle description se rapproche le plus de la manière dont cette activité rencontre d’autres personnes par la pratique, les réunions, la performance ou le partage ?","Racontez une scène montrant comment ce changement s’est ressenti dans la pratique, les réunions, la performance ou le rythme quotidien.","S’il y a eu une période où cela ne se voyait guère au-dehors, y avait-il quelque chose que vous continuiez de faire ? Même une toute petite chose compte.","Quelles conditions quotidiennes et concrètes influencent le rythme de cette activité ?","Quelles personnes, quels lieux, apprentissages ou appuis de la vie ont aidé cette activité à continuer ?"], PROFESSIONAL: ["À quoi ressemble votre activité aujourd’hui, et comment rencontre-t-elle le monde extérieur ?","Quelle description se rapproche le plus de l’état de votre activité culturelle ou artistique la plus importante ?","Quelle description se rapproche le plus de la manière dont cette activité rencontre actuellement l’extérieur ?","Racontez une chose qui a changé à ce moment-là.","S’il y a eu une période où votre activité était peu visible de l’extérieur, y avait-il quelque chose que vous continuiez de faire ? Même si personne ne le savait, cela compte.","Quelles réalités influencent votre manière actuelle de travailler ?","Quelle base ou quel moment vous a aidé à poursuivre cette activité jusqu’ici ?"] },
  es: { AUDIENCE: ["¿Cómo se encuentra con el arte y la cultura estos días?","¿Qué descripción se acerca más a su manera actual de encontrarse con las artes y la cultura?","¿Qué flujo se acerca más a sus visitas y participación reales?","Comparta un momento en que cambió su forma de encontrarse con las artes y la cultura.","Si hubo una época en que rara vez iba a funciones, exposiciones o programas, ¿seguía habiendo algún interés entonces? Aunque fuera por otro camino, cuenta.","¿Qué realidades influyen hoy en su forma de encontrarse con las artes y la cultura?","¿Qué le ha ayudado a volver a las artes y la cultura y a recordarlas?"], EVERYDAY: ["¿Cómo continúa esta actividad en su vida cotidiana estos días?","¿Qué descripción se acerca más a cómo continúa esta actividad estos días?","¿Qué descripción se acerca más a cómo esta actividad se encuentra con otras personas mediante práctica, reuniones, presentaciones o intercambio?","Comparta una escena que muestre cómo se sintió ese cambio en la práctica, las reuniones, la presentación o el ritmo cotidiano.","Si hubo una época en que apenas se notaba desde fuera, ¿había algo que seguía haciendo entonces? Aunque fuera algo muy pequeño, cuenta.","¿Qué condiciones cotidianas y prácticas influyen en el ritmo de esta actividad?","¿Qué personas, espacios, aprendizajes o apoyos cotidianos han ayudado a continuar esta actividad?"], PROFESSIONAL: ["¿Cómo es hoy su actividad y cómo se encuentra con el exterior?","¿Qué descripción se acerca más al estado de su actividad cultural o artística más importante?","¿Qué descripción se acerca más a cómo esa actividad se relaciona actualmente con el exterior?","Comparta una cosa que cambió en ese momento.","Si hubo una época en que su actividad apenas se veía desde fuera, ¿había algo que seguía haciendo entonces? Aunque nadie lo supiera, cuenta.","¿Qué realidades influyen en su manera actual de trabajar?","¿Qué base o momento le ha ayudado a continuar esta actividad hasta ahora?"] },
  nl: { AUDIENCE: ["Hoe komt u tegenwoordig in aanraking met kunst en cultuur?","Welke omschrijving past het best bij de manier waarop u nu kunst en cultuur ontmoet?","Welke omschrijving past het best bij uw daadwerkelijke bezoeken en deelname?","Vertel over één moment waarop de manier waarop u kunst en cultuur ontmoet veranderde.","Als er een tijd was waarin u zelden naar voorstellingen, tentoonstellingen of programma’s ging, bleef er toen toch een interesse bestaan? Ook via een andere weg telt het mee.","Welke omstandigheden beïnvloeden hoe u tegenwoordig kunst en cultuur ontmoet?","Wat heeft u geholpen om terug te keren naar kunst en cultuur en die te onthouden?"], EVERYDAY: ["Hoe gaat deze activiteit tegenwoordig door in uw dagelijks leven?","Welke omschrijving past het best bij hoe deze activiteit nu doorgaat?","Welke omschrijving past het best bij hoe deze activiteit via oefenen, bijeenkomsten, optredens of delen andere mensen ontmoet?","Vertel één scène die laat zien hoe die verandering voelde in oefenen, bijeenkomsten, optreden of het dagelijkse ritme.","Als er een tijd was waarin het naar buiten toe weinig opviel, was er dan iets wat u toen bleef doen? Ook iets heel kleins telt mee.","Welke dagelijkse en praktische voorwaarden beïnvloeden het ritme van deze activiteit?","Welke mensen, ruimtes, vormen van leren of dagelijkse steun hielpen deze activiteit voort te zetten?"], PROFESSIONAL: ["Hoe ziet uw activiteit er nu uit, en hoe ontmoet die de buitenwereld?","Welke omschrijving past het best bij de toestand van uw belangrijkste kunst- of cultuuractiviteit?","Welke omschrijving past het best bij de manier waarop die activiteit nu de buitenwereld ontmoet?","Vertel één ding dat rond die tijd veranderde.","Als er een tijd was waarin uw werk van buitenaf weinig zichtbaar was, was er dan iets wat u toen bleef doen? Ook als niemand ervan wist, telt het mee.","Welke realiteiten beïnvloeden uw huidige manier van werken?","Welke basis of welk moment heeft u geholpen deze activiteit tot nu toe voort te zetten?"] },
  ms: { AUDIENCE: ["Bagaimanakah anda bertemu seni dan budaya kebelakangan ini?","Huraian manakah yang paling hampir dengan cara anda bertemu seni dan budaya sekarang?","Aliran manakah yang paling hampir dengan lawatan dan penyertaan sebenar anda?","Kongsikan satu saat apabila cara anda bertemu seni dan budaya terasa berubah.","Jika pernah ada masa anda jarang menonton persembahan, pameran atau program, adakah minat yang masih berterusan ketika itu? Melalui jalan lain pun dikira.","Apakah keadaan yang mempengaruhi cara anda bertemu seni dan budaya sekarang?","Apakah yang membantu anda kembali kepada seni dan budaya serta mengingatinya?"], EVERYDAY: ["Bagaimanakah kegiatan ini diteruskan dalam kehidupan harian anda kebelakangan ini?","Huraian manakah yang paling hampir dengan cara kegiatan ini diteruskan sekarang?","Huraian manakah yang paling hampir dengan cara kegiatan ini bertemu orang lain melalui latihan, pertemuan, persembahan atau perkongsian?","Kongsikan satu adegan yang menunjukkan bagaimana perubahan itu dirasai dalam latihan, pertemuan, persembahan atau rentak harian.","Jika pernah ada masa ia tidak begitu ketara dari luar, adakah sesuatu yang anda terus lakukan ketika itu? Perkara yang sangat kecil pun dikira.","Apakah keadaan kehidupan dan realiti yang mempengaruhi rentak kegiatan ini?","Apakah orang, ruang, pembelajaran atau asas kehidupan yang membantu kegiatan ini berterusan?"], PROFESSIONAL: ["Bagaimanakah rupa kegiatan anda sekarang, dan bagaimana ia bertemu dunia luar?","Keadaan manakah yang paling hampir dengan aktiviti seni dan budaya anda yang paling penting?","Keadaan manakah yang paling hampir dengan cara kegiatan itu bertemu dengan luar sekarang?","Kongsikan satu perkara yang berubah pada waktu itu.","Jika pernah ada masa kegiatan anda tidak begitu kelihatan dari luar, adakah sesuatu yang anda terus lakukan ketika itu? Walaupun tiada siapa yang tahu, ia tetap dikira.","Apakah realiti yang mempengaruhi cara anda bekerja sekarang?","Apakah asas atau pencetus yang membolehkan anda meneruskan kegiatan ini sehingga kini?"] },
};
